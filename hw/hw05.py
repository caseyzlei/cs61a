class VendingMachine:
    ...
    def add_funds(self, deposit):
        if self.stock == 0:
            return 'Inventory empty. Restocking required. Here is your ${0}.'.format(deposit)
    ...
    def vend(self):
        ...
        if diff < 0:
            ...
            self.balance = 0
            self.stock -= 1
            return 'Here is your {0} and ${1} change.'.format(self.item, diff)
        else:
            self.balance = 0
            self.stock -= 1
