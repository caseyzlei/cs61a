...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who==0:
            prev_score0 = score0
            score0 = prev_score0 + take_turn(strategy0(score0, score1), score1, dice)
            if score0 != prev_score0:
        ...
        if who==1:
            prev_score1 = score1
            score1 = prev_score1 + take_turn(strategy1(score1, score0), score0, dice)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            last = last_score
            if last_high < score0 - last:
                last_high = score0 - last
                print(last_high, "point(s)! The most yet for Player", who)
                last = score0
            else:
                last = score0
        if who == 1:
            last_high = running_high
            last = last_score
            if last_high < score1 - last: 
                last_high = score1 - last 
                print(last_high, "point(s)! The most yet for Player", who)
                last = score1 
            else:
                last = score1
            
        return announce_highest(who, last, last_high)
    return say
    # END PROBLEM 7
